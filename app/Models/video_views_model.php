...
class video_views_model extends Model{
     ...
     * @var string
     */
    protected $table = 'tbl_video_views';
     ...
     * Get the module that owns the video.
     */
    public function ClipViews()
    {
        return $this->belongsTo('App\Models\clip_views_model', 'video_id','video_id');
    }
