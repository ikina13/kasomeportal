...
class ViewsRelationManager extends RelationManager
{
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('user.region')->required(),
                 Forms\Components\TextInput::make('user.district')->required(),
        ...
        return $table
            ->columns([
                //
                 ...
                 Tables\Columns\TextColumn::make('user.region')->label('Region')->searchable(),
                 Tables\Columns\TextColumn::make('user.district')->label('District')->searchable(),
    ...
    {
        return parent::getTableQuery()->with('user','video')->orderBy('created_at', 'desc');
    }  
}
