...
use App\Filament\Resources\AppUserResource\RelationManagers\ClassSubscriptionsRelationManager;
...
class AppUserResource extends Resource
{
                 ...
                 Forms\Components\Card::make()
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('phone')
                            ->dehydrateStateUsing(fn ($state) => AppUser::getformatted($state))
                        ...
                        Forms\Components\TextInput::make('email')
                            ->label('Email Address')
                            ->email() // This adds the email format validation
                            ->maxLength(255), // Good practice for database limits

                         Forms\Components\Section::make('Change Password')
                        ->description('Update the user password here.')
                        ->collapsible()
                        // MODIFIED: This is a more robust way to check if you're on an edit page.
    ...
    public static function getRelations(): array
    {
        return [
            ...
            ClassSubscriptionsRelationManager::class,
        ];
    }
