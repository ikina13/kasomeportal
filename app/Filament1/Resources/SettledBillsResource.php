    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('users.name')->label('Name'),
                Tables\Columns\TextColumn::make('users.phone')->label('Phone'),
                Tables\Columns\TextColumn::make('video.name')->label('Course'),
